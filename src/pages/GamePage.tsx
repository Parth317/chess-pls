    ...
    <div className="h-screen w-full flex flex-col font-sans selection:bg-blue-500/30 relative overflow-hidden">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto p-0 lg:p-4 grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-0 lg:gap-4 items-start min-h-0 overflow-y-auto lg:overflow-hidden relative z-0">
        ...
        <div className="flex flex-col gap-0 lg:gap-2 h-full w-full min-w-0 relative">
          ...
          <div className="lg:flex-1 lg:min-h-0 w-full relative bg-slate-900 lg:bg-transparent overflow-hidden z-0">
            <div
              onClick={() => log("Board Container Clicked")}
              className="aspect-square w-full lg:w-auto lg:h-full lg:max-h-full lg:max-w-full bg-slate-800 lg:rounded-lg shadow-2xl overflow-hidden border-0 lg:border-4 border-slate-700/50 relative lg:absolute lg:inset-0 lg:m-auto"
            >
              <ChessgroundBoard
                game={game}
                orientation="white"
          ...
          {/* User HUD - Mobile (Flat) and Desktop (Floating) */}
          <div className="flex justify-between items-center bg-slate-800 px-3 border-b border-t border-slate-700 lg:border lg:rounded-xl lg:shadow-md shrink-0 h-16 lg:h-20 z-10 relative">
            <div className="flex items-center gap-3">
